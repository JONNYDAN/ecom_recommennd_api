...
const {generateAvatar} = require('../utils/avatar_gen');
...
const createAvatar   =  asyncHandler(async (req, res) => {
    generateAvatar("lorelei", 'avatars', "temp")
    res.json({ code: 200, status: true, message: 'Avatar created successfully' });
})
...
module.exports = {
    addAvatar, getAllAvatars, createAvatar
};